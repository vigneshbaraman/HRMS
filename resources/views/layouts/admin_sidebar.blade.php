    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar ">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li class="user-pro  hidden-sm hidden-md hidden-lg">
                    ...
                    <li><a href="../logout" onclick="event.preventDefault();
                        ...
                        <form id="logout-form" action="../logout" method="POST" style="display: none;">
                            <input type="hidden" name="_token" value="1epOZkrUzaziuLC7NCF6GFUnSECkeEl9imkUTDI2">
                        </form>
                    </li>
                </ul>
            </li>
           ...
           <!--  Sidebar category start -->
            ...
            <li><a href="{{route('admin_dashboard')}}" class="waves-effect"><i class="icon-speedometer fa-fw"></i> <span class="hide-menu">Dashboard </span></a> </li>

            <li><a href="../member/task" class="waves-effect"><i class="ti-layout-list-thumb fa-fw"></i> <span class="hide-menu"> Masters <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
            ...
            <li><a href="{{route('permission')}}" class="waves-effect"><i class="ti-settings fa-fw"></i> <span class="hide-menu"> Settings</span></a>
            </li>
