    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar ">
        ...
        <ul class="nav" id="side-menu">
           ...
           <!--  Sidebar category start -->
            ...
            <li><a href="../HRSS" class="waves-effect"><i class="icon-speedometer fa-fw"></i><span class="hide-menu">Dashboard </span></a> </li>
            <li><a href="{{url('hrsspreOnboarding')}}" class="waves-effect"><i class="ti-layout-list-thumb fa-fw"></i> <span class="hide-menu">Pre OnBoarding </span></a> </li>
            <li><a href="../hrssCandidate" class="waves-effect"><i class="icon-speedometer fa-fw"></i> <span class="hide-menu">candidate </span></a> </li>
            {{-- <li><a href="../candidate_profile_add" class="waves-effect"><i class="icon-speedometer fa-fw"></i> <span class="hide-menu">Add Candidate </span></a> </li> --}}
            <li><a href="../Hrss_profile" class="waves-effect"><i class="icon-speedometer fa-fw"></i> <span class="hide-menu">profile </span></a> </li>
