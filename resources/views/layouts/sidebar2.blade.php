    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar ">
        ...
        <ul class="nav" id="side-menu">
           ...
           <!--  Sidebar category start -->
            ...
            <li><a href="../buddy_dashboard" class="waves-effect"><i class="icon-speedometer fa-fw"></i> <span class="hide-menu">Dashboard </span></a> </li>

            <li><a href="../buddy" class="waves-effect"><i class="ti-user fa-fw"></i> <span class="hide-menu">Buddy Info </span></a> </li>

            <li><a href="../buddy_profile" class="waves-effect"><i class="ti-user fa-fw"></i> <span class="hide-menu">Profile </span></a> </li>
