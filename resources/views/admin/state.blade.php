                ...
                <div class="
                    ...
                    <div class="row bg-title">
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 bg-title-left">
                            <h4 class="page-title"><i class="icon-user"></i> State </h4>
                        </div>
                        <!-- /.page title -->
                        <!-- .breadcrumb -->
                        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
                            <a href="#" id="add_state"
                                class="btn btn-outline btn-success btn-sm">Add State <i class="fa fa-plus"
                    ...
                    <!-- .row -->
                    <div class="modal fade bs-modal-md in" id="stateModal" role="dialog"
