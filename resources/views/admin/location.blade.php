                ...
                <div class="
                    ...
                    <div class="row bg-title">
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 bg-title-left">
                            <h4 class="page-title"><i class="icon-user"></i> Work Location </h4>
                        </div>
                        <!-- /.page title -->
                        <!-- .breadcrumb -->
                        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
                            <a href="#" id="add_location"
                                class="btn btn-outline btn-success btn-sm">Add Work Location <i class="fa fa-plus"
                                    aria-hidden="true"></i></a>

                            <ol class="breadcrumb">
                                <li><a href="http://127.0.0.1:8080/admin/dashboard">Home</a></li>
                                <li class="active">Work Location</li>
                            </ol>
                        </div>
                        <!-- /.breadcrumb -->
                    </div>
                    ...
                    <!-- .row -->
                    <div class="modal fade bs-modal-md in" id="locationModal" role="dialog"
