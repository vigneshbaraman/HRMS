                ...
                <div class="
                    ...
                    <div class="row bg-title">
                        ...
                        <div class="col-lg-6 col-md-4 col-sm-4 col-xs-12 bg-title-left">
                            <h4 class="page-title"><i class="icon-user"></i> Roll of Intake </h4>
                        </div>
                        <!-- /.page title -->
                        <!-- .breadcrumb -->
                        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
                            <a href="#" id="add_roll"
                                class="btn btn-outline btn-success btn-sm">Add Roll of Intake <i class="fa fa-plus"
                                    aria-hidden="true"></i></a>

                            <ol class="breadcrumb">
                                <li><a href="http://127.0.0.1:8080/admin/dashboard">Home</a></li>
                                <li class="active">Roll of Intake</li>
                            </ol>
                        </div>
                        <!-- /.breadcrumb -->
                    </div>
                    ...
                    <!-- .row -->
                    <div class="modal fade bs-modal-md in" id="rollModal" role="dialog"
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 ">
                                                    <div class="form-group">
                                                        <label>Roll of Intake Name</label>
